<?php
	...
	elseif($page == 'promotion'){
		...
		Jouw link waar iemand zich gemakkelijk mee kan aanmelden is:<br /><br /><strong>'.GLOBALDEF_PROTOCOL.'://www.'.GLOBALDEF_SITEDOMAIN.'.nl/index.php?page=register&referer='.$_SESSION['naam'].'</strong></p>';
	}
