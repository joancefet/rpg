...
function create_player($attack_info){
  ...
  while($pokemonopzak = mysql_fetch_array($pokemonopzaksql)){
    ...
    mysql_query("INSERT INTO `pokemon_speler_gevecht` (`id`, `user_id`, `aanval_log_id`, `levenmax`, `leven`, `exp`, `totalexp`, `effect`, `hoelang`) 
      VALUES ('".$pokemonopzak['id']."', '".$_SESSION['id']."', '".$_SESSION['attack']['aanval_log_id']."', '".$pokemonopzak['levenmax']."', '".$pokemonopzak['leven']."', '".$pokemonopzak['exp']."', '".$pokemonopzak['totalexp']."', '".$pokemonopzak['effect']."', '".$pokemonopzak['hoelang']."')");
  }
}
...
function save_new_computer($new_computer,$new_computer_sql,$computer_level){
  ...
  //Save Computer
  mysql_query("INSERT INTO `pokemon_wild_gevecht` (`wildid`, `aanval_log_id`, `shiny`, `level`, `levenmax`, `leven`, `attack`, `defence`, `speed`, `spc.attack`, `spc.defence`, `aanval_1`, `aanval_2`, `aanval_3`, `aanval_4`, `effect`) 
