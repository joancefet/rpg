...
$captcha_page_check = array('1241241421');
...
function GetEventLanguage($land){
	if(($land == 'Nederland') || ($land == 'Belgium')) return 'nl';
...
function update_pokedex($wild_id,$old_id,$wat){
  ...
  if(!empty($query)) mysql_query("UPDATE gebruikers SET ".$query." WHERE user_id='".$_SESSION['id']."'");
}
...
function max_min_price($pokemon){
  ...
  $shinywaard = 150;
  if($pokemon['shiny'] == 0) $shinywaard = 100; 
...
function rankerbij($soort,$txt){
  ...
  elseif($soort == "standaard") $soort = 1;
  ...
  if($spelerrank['rankexpnodig'] <= $spelerrank['rankexp']){
	...
	if($ranknieuw == 34 )
	mysql_query("UPDATE `gebruikers` SET `rank`='33', `rankexp`='1', `rankexpnodig`='170000000' WHERE `user_id`='".$_SESSION['id']."'");
    else
  ...
  if(strpos($zin, "[") === false) {
    if(strpos($zin, "]") === false) {
      ...
      for ($i = 0; $i <= sizeof($woord); $i++) {
        ...
        if(strlen($woord[$i]) > 50)
          $woord[$i] = wordwrap($woord[$i], 50, "\n", true);
        //Woord toevoegen
        $woorden[] = $woord[$i];
      }
      //Voor elke 15 woorden een zin maken
      for ($ii = 0; $ii < count($woorden); $ii+=15) {
          $zinnn .= $woorden[$ii]." ".$woorden[$ii+1]." ".$woorden[$ii+2]." ".$woorden[$ii+3]." ".$woorden[$ii+4]." ".$woorden[$ii+5]."
          ".$woorden[$ii+6]." ".$woorden[$ii+7]." ".$woorden[$ii+8]." ".$woorden[$ii+9]." ".$woorden[$ii+10]." ".$woorden[$ii+11]." ".$woorden[$ii+12]." ".$woorden[$ii+13]." ".$woorden[$ii+14];
      }
...
function pokemon_popup($pokemon,$txt){
  ...
  if($pokemon['shiny'] == 1) $img = "<img src=&quot;images/icons/lidbetaald.png&quot; style=&quot;margin-bottom: -3px;&quot;>";
...
function getCurrentMusic($page){
  ...
  elseif($page == "information"
      ...
      or $page == "rankinglist"
      or $page == "home"
      or $page == "forum-categories"
      or $page == "extended"
      or $page == "modify-order"
      or $page == "modify-order-old"
      or $page == "house"
      or $page == "release"
      or $page == "items"
      or $page == "badges"
  ...
  elseif($page == "town"
      or $page == "bank"
      or $page == "daycare"
      or $page == "name-specialist"
      or $page == "shiny-specialist"
      or $page == "market"
      or $page == "pokemarket"){
  ...
  elseif($page == "casino"
      or $page == "flip-a-coin"
      or $page == "who-is-it-quiz"
      or $page == "wheel-of-fortune"
      or $page == "poke-scrambler"
      or $page == "kluis"
      or $page == "mystery-gift") {
...
function showEmoticons() {
    $emoticons = array(
        array("symbols" => "&lt;3","icon" => "<img src='../images/shoutbox_icons/emoticon_heart.png' alt='heart' title='heart' style='border:none;height:16px;width:16px;vertical-align: middle;' />"),
        array("symbols" => "(Y)","icon" => "<img src='../images/shoutbox_icons/emoticon_thumbsup.png' alt='thumbsup' title='thumbsup' style='border:none;height:16px;width:16px;vertical-align: middle;' />"),
        array("symbols" => "(V)","icon" => "<img src='../images/shoutbox_icons/emoticon_peace.png' alt='peace' title='peace' style='border:none;height:16px;width:16px;vertical-align: middle;' />"),
        array("symbols" => ":)","icon" => "<img src='../images/shoutbox_icons/emoticon_smile.png' alt='smile' title='smile' style='border:none;height:16px;width:16px;vertical-align: middle;' />"),
        array("symbols" => ":-)","icon" => "<img src='../images/shoutbox_icons/emoticon_smile.png' alt='smile' title='smile' style='border:none;height:16px;width:16px;vertical-align: middle;' />"),
        array("symbols" => "=]","icon" => "<img src='../images/shoutbox_icons/emoticon_happy.png' alt='happy' title='happy' style='border:none;height:16px;width:16px;vertical-align: middle;' />"),
        array("symbols" => ":D","icon" => "<img src='../images/shoutbox_icons/emoticon_grin.png' alt='grin' title='grin' style='border:none;height:16px;width:16px;vertical-align: middle;' />"),
        array("symbols" => "xD","icon" => "<img src='../images/shoutbox_icons/emoticon_evilgrin.png' alt='evilgrin' title='evilgrin' style='border:none;height:16px;width:16px;vertical-align: middle;' />"),
        array("symbols" => ":(","icon" => "<img src='../images/shoutbox_icons/emoticon_sad.png' alt='sad' title='sad' style='border:none;height:16px;width:16px;vertical-align: middle;' />"),
        array("symbols" => "(H)","icon" => "<img src='../images/shoutbox_icons/emoticon_cool.png' alt='cool' title='cool' style='border:none;height:16px;width:16px;vertical-align: middle;' />"),
        array("symbols" => ":o","icon" => "<img src='../images/shoutbox_icons/emoticon_surprised.png' alt='surprised' title='surprised' style='border:none;height:16px;width:16px;vertical-align: middle;' />"),
        array("symbols" => ":P","icon" => "<img src='../images/shoutbox_icons/emoticon_tongue.png' alt='tongue' title='tongue' style='border:none;height:16px;width:16px;vertical-align: middle;' />"),
        array("symbols" => "3-)","icon" => "<img src='../images/shoutbox_icons/emoticon_waii.png' alt='waii' title='waii' style='border:none;height:16px;width:16px;vertical-align: middle;' />"),
        array("symbols" => ";)","icon" => "<img src='../images/shoutbox_icons/emoticon_wink.png' alt='wink' title='wink' style='border:none;height:16px;width:16px;vertical-align: middle;' />"),
        array("symbols" => ":@","icon" => "<img src='../images/shoutbox_icons/emoticon_angry.png' alt='angry' title='angry' style='border:none;height:16px;width:16px;vertical-align: middle;' />"),
        array("symbols" => ":'(","icon" => "<img src='../images/shoutbox_icons/emoticon_crying.png' alt='crying' title='crying' style='border:none;height:16px;width:16px;vertical-align: middle;' />"),
        array("symbols" => "[gold]","icon" => "<img src='../images/shoutbox_icons/emoticon_gold.png' alt='gold' title='gold' style='border:none;height:16px;width:16px;vertical-align: middle;' />"),
        array("symbols" => "[silver]","icon" => "<img src='../images/shoutbox_icons/emoticon_silver.png' alt='silver' title='silver' style='border:none;height:16px;width:16px;vertical-align: middle;' />")
    );
    return $emoticons;
}
function insertableEmoticons() {
    $emoticons = array(
        "<img style='cursor: pointer;' onclick=\"insertSmiley('&lt;3')\" src='../images/shoutbox_icons/emoticon_heart.png' alt='heart' title='heart' style='border:none;height:16px;width:16px;vertical-align: middle;' />",
        "<img style='cursor: pointer;' onclick=\"insertSmiley('(Y)')\" src='../images/shoutbox_icons/emoticon_thumbsup.png' alt='thumbsup' title='thumbsup' style='border:none;height:16px;width:16px;vertical-align: middle;' />",
        "<img style='cursor: pointer;' onclick=\"insertSmiley('(V)')\" src='../images/shoutbox_icons/emoticon_peace.png' alt='peace' title='peace' style='border:none;height:16px;width:16px;vertical-align: middle;' />",
        "<img style='cursor: pointer;' onclick=\"insertSmiley(':-)')\" src='../images/shoutbox_icons/emoticon_smile.png' alt='smile' title='smile' style='border:none;height:16px;width:16px;vertical-align: middle;' />",
        "<img style='cursor: pointer;' onclick=\"insertSmiley('=]')\" src='../images/shoutbox_icons/emoticon_happy.png' alt='happy' title='happy' style='border:none;height:16px;width:16px;vertical-align: middle;' />",
        "<img style='cursor: pointer;' onclick=\"insertSmiley(':D')\" src='../images/shoutbox_icons/emoticon_grin.png' alt='grin' title='grin' style='border:none;height:16px;width:16px;vertical-align: middle;' />",
        "<img style='cursor: pointer;' onclick=\"insertSmiley('xD')\" src='../images/shoutbox_icons/emoticon_evilgrin.png' alt='evilgrin' title='evilgrin' style='border:none;height:16px;width:16px;vertical-align: middle;' />",
        "<img style='cursor: pointer;' onclick=\"insertSmiley(':(')\" src='../images/shoutbox_icons/emoticon_sad.png' alt='sad' title='sad' style='border:none;height:16px;width:16px;vertical-align: middle;' />",
        "<img style='cursor: pointer;' onclick=\"insertSmiley('(H)')\" src='../images/shoutbox_icons/emoticon_cool.png' alt='cool' title='cool' style='border:none;height:16px;width:16px;vertical-align: middle;' />",
        "<img style='cursor: pointer;' onclick=\"insertSmiley(':o')\" src='../images/shoutbox_icons/emoticon_surprised.png' alt='surprised' title='surprised' style='border:none;height:16px;width:16px;vertical-align: middle;' />",
        "<img style='cursor: pointer;' onclick=\"insertSmiley(':P')\" src='../images/shoutbox_icons/emoticon_tongue.png' alt='tongue' title='tongue' style='border:none;height:16px;width:16px;vertical-align: middle;' />",
        "<img style='cursor: pointer;' onclick=\"insertSmiley('3-)')\" src='../images/shoutbox_icons/emoticon_waii.png' alt='waii' title='waii' style='border:none;height:16px;width:16px;vertical-align: middle;' />",
        "<img style='cursor: pointer;' onclick=\"insertSmiley(';)')\" src='../images/shoutbox_icons/emoticon_wink.png' alt='wink' title='wink' style='border:none;height:16px;width:16px;vertical-align: middle;' />",
        "<img style='cursor: pointer;' onclick=\"insertSmiley(':@')\" src='../images/shoutbox_icons/emoticon_angry.png' alt='angry' title='angry' style='border:none;height:16px;width:16px;vertical-align: middle;' />",
        "<img style='cursor: pointer;' onclick=\"insertSmiley(':\'(')\" src='../images/shoutbox_icons/emoticon_crying.png' alt='crying' title='crying' style='border:none;height:16px;width:16px;vertical-align: middle;' />",
        "<img style='cursor: pointer;' onclick=\"insertSmiley('[gold]')\" src='../images/shoutbox_icons/emoticon_gold.png' alt='gold' title='gold' style='border:none;height:16px;width:16px;vertical-align: middle;' />",
        "<img style='cursor: pointer;' onclick=\"insertSmiley('[silver]')\" src='../images/shoutbox_icons/emoticon_silver.png' alt='silver' title='silver' style='border:none;height:16px;width:16px;vertical-align: middle;' />"
    );
    return $emoticons;
}
...
function getYoutubeID($url) {
    $pattern = 
        '%^# Match any youtube URLgetYoutubeID
