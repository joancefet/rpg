...
?>
            ...
            <?php
				...
				$attackquery = mysql_query("SELECT naam, sterkte, soort, mis, effect_kans, effect_naam, klaar FROM aanval ORDER BY naam ASC LIMIT ".$pagina.", ".$max."");
				
				for($number = 1; $attack = mysql_fetch_array($attackquery); $number ++){
					...
					echo '<tr>
					  ...
					  $links = false;
					  $rechts = false;
					  echo '<tr><td colspan=7><br /><center><div class="sabrosus">';
					  if($subpage == 1)
